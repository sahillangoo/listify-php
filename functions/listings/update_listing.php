...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $sql = "UPDATE listings SET business_name = :business_name, description = :description, category = :category, address = :address, city = :city, whatsapp = :whatsapp, instagram_id = :instagram_id, phone_number = :phone_number, email = :email, display_image = :display_image WHERE id = :id";
